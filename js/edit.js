function appendRow()
{
    ...
    c2.innerHTML = '<td><input type ="hidden" id="answer_id" name="answer_id[]" value = "new"><input type="text" id="answer" name="answer[]" placeholder="Answer" class="validate[maxSize[255]]" ></td>';
    c3.innerHTML = '<td><input class="delbtn" type="button" id="delBtn' + count + '"  value="delete" onclick="deleteRow(this)"></td>';
